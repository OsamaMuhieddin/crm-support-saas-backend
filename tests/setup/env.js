...
process.env.REALTIME_TRANSPORTS = 'websocket,polling';
process.env.REALTIME_PING_INTERVAL_MS = '25000';
process.env.REALTIME_PING_TIMEOUT_MS = '20000';
process.env.REALTIME_CORS_ORIGIN = 'http://frontend.local';
process.env.REALTIME_PRESENCE_TTL_MS = '1200';
process.env.REALTIME_TYPING_TTL_MS = '1100';
process.env.REALTIME_SOFT_CLAIM_TTL_MS = '1200';
process.env.REALTIME_ACTION_THROTTLE_MS = '75';
process.env.REALTIME_DEBUG_LOGGING = 'false';
process.env.REDIS_ENABLED = 'false';
process.env.REDIS_URL = 'redis://127.0.0.1:6379';
process.env.REALTIME_REDIS_ENABLED = 'false';
