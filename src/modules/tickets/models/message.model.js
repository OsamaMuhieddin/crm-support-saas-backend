...
import { MESSAGE_DIRECTION_VALUES, MESSAGE_DIRECTION } from '../../../constants/message-direction.js';
...
messageSchema.index({ workspaceId: 1, ticketId: 1, createdAt: 1 });
messageSchema.index({ workspaceId: 1, mailboxId: 1, createdAt: 1 });
